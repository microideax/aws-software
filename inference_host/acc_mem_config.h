/* This file should be generated with the accelerator system address allocation file &
 * accelerator number customization file*/

#ifndef _ACC_CONFIG_H_
#define _ACC_CONFIG_H_

/*TODO: should change the name to ACC_CTRL_REG */
// Accelerator control register memory space
...
// Accelerator CONV computing control register address
#define CONV_CORE_PARAM UINT64_C(0xC2000000)
// Accelerator POOL computing control register address
...
// Accelerator weight memory spaces
// acc_weight[0][][][]
#define W_MEM_STEP UINT64_C(0x00001000)
...
#define CONV_W_BRAM_PCIS_0_8 UINT64_C(0x06008000)
#define CONV_W_BRAM_PCIS_0_9 UINT64_C(0x06009000)
#define CONV_W_BRAM_PCIS_0_10 UINT64_C(0x0600A000)
#define CONV_W_BRAM_PCIS_0_11 UINT64_C(0x0600B000)
#define CONV_W_BRAM_PCIS_0_12 UINT64_C(0x0600C000)
#define CONV_W_BRAM_PCIS_0_13 UINT64_C(0x0600D000)
#define CONV_W_BRAM_PCIS_0_14 UINT64_C(0x0600E000)
#define CONV_W_BRAM_PCIS_0_15 UINT64_C(0x0600F000)
...
// Accelerator bias memory space
#define BIAS_MEM_STEP UINT64_C(0x00001000)
#define CONV_B_BRAM_PCIS UINT64_C(0xC0000000)

// Accelerator data input mem spaces, double buffered
#define IN_MEM_STEP UINT64_C(0x00001000)
...
// Accelerator data output mem spaces, double buffered
#define OUT_MEM_STEP UINT64_C(0x00001000)
