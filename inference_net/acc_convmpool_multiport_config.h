...
#define CONV_W_BRAM_PCIS UINT64_C(0xC8000000)
...
#define BUF_OUT_0_1 UINT64_C(0xC2008000)
#define BUF_OUT_0_2 UINT64_C(0xC2010000)
#define BUF_OUT_0_3 UINT64_C(0xC2018000)
#define BUF_OUT_0_4 UINT64_C(0xC2020000)
#define BUF_OUT_0_5 UINT64_C(0xC2028000)
#define BUF_OUT_0_6 UINT64_C(0xC2030000)
#define BUF_OUT_0_7 UINT64_C(0xC2038000)
...
#define BUF_OUT_1_1 UINT64_C(0xC6001000)
#define BUF_OUT_1_2 UINT64_C(0xC6002000)
#define BUF_OUT_1_3 UINT64_C(0xC6003000)
#define BUF_OUT_1_4 UINT64_C(0xC6004000)
#define BUF_OUT_1_5 UINT64_C(0xC6005000)
#define BUF_OUT_1_6 UINT64_C(0xC6006000)
#define BUF_OUT_1_7 UINT64_C(0xC6007000)
